...
$stage = Join-Path $root 'artifacts\rpi5-wifi-performance-0.6.27.1'
...
$files = @{
    ...
    'utility\RPi5-WiFi-DownloadTiming.ps1'='RPi5-WiFi-DownloadTiming.ps1'
    'utility\RPi5-WiFi-MeasurementClock.ps1'='RPi5-WiFi-MeasurementClock.ps1'
    ...
    'utility\RPi5-WiFi-Operations.ps1'='RPi5-WiFi-Operations.ps1'
    'utility\Check-RPi5-WiFi-Readiness.ps1'='Check-RPi5-WiFi-Readiness.ps1'
...
$zip = Join-Path $root 'artifacts\RPi5-WiFi-Performance-0.6.27.1.zip'
