...
$stage = Join-Path $root 'artifacts\rpi5-wifi-performance-0.6.26'
...
$files = @{
    ...
    'docs\PERFORMANCE-0.6.26.md'='README.md'
    'LICENSE'='LICENSE'
}
...
$zip = Join-Path $root 'artifacts\RPi5-WiFi-Performance-0.6.26.zip'
