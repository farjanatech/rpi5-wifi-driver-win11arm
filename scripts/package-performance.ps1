...
$stage = Join-Path $root 'artifacts\rpi5-wifi-performance-0.6.27'
...
$files = @{
    ...
    'docs\PERFORMANCE-0.6.27.md'='README.md'
    'LICENSE'='LICENSE'
}
...
$zip = Join-Path $root 'artifacts\RPi5-WiFi-Performance-0.6.27.zip'
