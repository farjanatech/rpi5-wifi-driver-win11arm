...
int main(void)
{
    ...
    CHECK(CywPacketKind(b,42)==1);CHECK(CywPacketKind(b,60)==1);
    b[21]=2;CHECK(CywPacketKind(b,42)==2);
    b[19]=16;CHECK(CywPacketKind(b,42)==0);
    memset(b,0,sizeof(b));b[12]=8;b[14]=0x45;b[17]=28;b[23]=1;
    CHECK(CywPacketKind(b,42)==3);CHECK(CywPacketKind(b,41)==0);
    b[23]=17;CHECK(CywPacketKind(b,42)==4);
    b[23]=6;CHECK(CywPacketKind(b,42)==5);
    b[14]=0x4f;CHECK(CywPacketKind(b,42)==0);
    b[14]=0x44;CHECK(CywPacketKind(b,42)==0);
    b[14]=0x65;CHECK(CywPacketKind(b,42)==0);
    b[12]=0x86;b[13]=0xdd;b[14]=0x60;
    CHECK(CywPacketKind(b,54)==6);CHECK(CywPacketKind(b,53)==0);
    b[12]=0x81;b[13]=0;CHECK(CywPacketKind(b,54)==0);
